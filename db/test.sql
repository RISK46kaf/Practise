...
DELIMITER $$
USE `default_schema`$$
CREATE PROCEDURE `Fill_Adress` (in inRegion int, in inDistrict int, in inCity int, in inStreet int, in inHouse int, in inHousing int, in inAppartement int)
BEGIN
...
-- -----------------------------------------------------
-- procedure View_Anamnesys
-- -----------------------------------------------------

USE `default_schema`;
DROP procedure IF EXISTS `default_schema`.`View_Anamnesys`;

DELIMITER $$
USE `default_schema`$$
CREATE PROCEDURE `View_Anamnesys` ()
BEGIN
