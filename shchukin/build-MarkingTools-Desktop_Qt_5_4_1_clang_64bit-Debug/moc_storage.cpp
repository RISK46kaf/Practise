...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Storage_t, stringdata) + ofs \
...
const QMetaObject Storage::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_Storage.data,
      qt_meta_data_Storage,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Storage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Storage.stringdata))
